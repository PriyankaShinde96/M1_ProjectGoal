...
void namefun(){
	...
	double phone;
	char gender[8];
	fptr=fopen("priya.txt","ab+");//ab+ gives us the ability of writing the function and add the second data in the existing one...
	if(fptr==NULL){
